# NKR Ground Control Station 0.3.1
...
- Make the settings-path test explicitly validate both Linux and Windows paths.

## Validation

- Gray-code marker and SNTP calculations have deterministic unit tests.
- Windows packaging runs the complete GCS test suite before its executable
  smoke test.
...
See [INSTALL.md](https://github.com/benderitto/nkr-gcs/blob/v0.3.1/INSTALL.md) for installation and Tailscale setup.
